  ...
  const formatLegendValue = (value, name) => {
    ...
    return (
      <div className="custom-legend-item-text-group">
        ...
        <span className="custom-legend-item-value">{" " + totalValue}</span>
      </div>
    )
  };
    ...
    <div className='block-wrap w-full mt-[14px] lg:mt-0'>
      ...
      <div className="area-chart w-full h-[250px]">
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart width={730} height={250} data={state}
            ...
            <defs>
              ...
              <linearGradient id="colorTm" x1="0" y1="0" x2="0" y2="1">
            ...
            <Tooltip />
            <Area type="monotone" dataKey="last_month" stroke="#8884d8" fillOpacity={1} fill="url(#colorLm)" />
            <Area type="monotone" dataKey="this_month" stroke="#82ca9d" fillOpacity={1} fill="url(#colorTm)" />
          </AreaChart>
        </ResponsiveContainer>
      </div>
    </div>
